% Documento di prova di TEX2PDF.
%
% È un corpo, non un documento completo: non contiene \documentclass né
% \begin{document}, perché quelle righe le mette il template.
%
% Lo stesso testo vive in src/lib/esempio.js, da dove il programma lo carica
% all'avvio: modificando questo file, riporta la modifica anche lì.
